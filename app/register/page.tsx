      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <Card className="w-full shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-3">
            <CardTitle className="text-2xl text-center text-gray-800">Registro</CardTitle>
            <CardDescription className="text-center text-gray-600">
              Crea una cuenta para comenzar a personalizar tus velas
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link href="/login" className="text-[#4BBDB7] hover:text-[#3A9B96] font-medium transition-colors">
                Inicia sesión aquí
              </Link>
            </div>
          </CardContent>
